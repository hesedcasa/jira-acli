...
* [`jira-acli auth test`](#jira-acli-auth-test)
...
```
USAGE
  $ jira-acli auth add -e <value> -t <value> -u <value> [--json]
...
```
USAGE
  $ jira-acli auth update -e <value> -t <value> -u <value> [--json]
